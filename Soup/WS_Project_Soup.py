...
for i in url:
    try:
        ...
        for phone in phone_details[3:]:
            ...
            #I can adjust the below line of code to have all the separate elements of the phones as a full data frame too
...
#We can either be converting into a Dataframe and them exporting
